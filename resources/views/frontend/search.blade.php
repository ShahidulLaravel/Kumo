                    ...
                    <div class="col-lg-12 text-center">
                        @if ($searched_product->count() == 0)
                            <div class="alert alert-info">
                                <h3>No Searched Product Found</h3>
                            </div>
                        @endif
                    </div>
                </div>
...
<script>
    $('#search_btn').click(function(){
        ...
        var link = '{{route('search')}}'+'?q='+search_input+'&min='+min+'&max='+max+'&category_id='+category_id+"&brand_id="+brand+"&color_id="+color_id+"&size_id="+size_id+"&sort="+sorting;
